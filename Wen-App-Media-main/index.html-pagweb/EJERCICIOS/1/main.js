...
suma = parseFloat(num1) + parseFloat(num1);
resta = parseFloat(num1) - parseFloat(num1);
multiplicacion = parseFloat(num1) * parseFloat(num1);
division = parseFloat(num1) / parseFloat(num1);
